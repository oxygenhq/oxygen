...
module.exports = function() {
     ...
     * @return {Object} Email body(possible keys: html,text,textAsHtml), attachments(every attachment have filename<String> and data<Buffer>) and TO, FROM, SUBJECT, DATE headers.
