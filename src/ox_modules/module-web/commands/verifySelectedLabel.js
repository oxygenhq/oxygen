...
/**
 * @summary Verifies text of the currently selected option in a drop-down list.
 ...
 */
export async function verifySelectedLabel(locator, pattern, timeout, waitForVisible = true) {
