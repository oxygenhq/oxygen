...
/**
 * @summary Verifies whether the given text is present somewhere on the page. That is whether an
 ...
 */
export async function verifyTextPresent(text, timeout) {
    ...
    try {
        ...
        throw new this.OxError(this.errHelper.errorCode.VERIFY_ERROR, `Text: "${text}" not found on the page`, undefined, false);
    }
