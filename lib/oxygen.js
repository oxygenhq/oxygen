        ...
        try {
            ...
            if (debugMode && dbg && tc) {
                ...
                for (var bp of breakpoints) {
                    if (!tsBreakpoints.includes(bp)) {
                        promises.push(dbg.setBreakpoint(filePath, bp));
                    }
                }

                // remove deleted breakpoints
                for (var bp of tsBreakpoints) {
                    if (!breakpoints.includes(bp)) {
                        promises.push(dbg.removeBreakpointByValue(filePath, bp));
                    }
                }
