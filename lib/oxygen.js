...
module.exports.Runner = function () {
    ...
    module.init = function (options) {
        ...
        if (options.debugPort) {
            forkExecArgv = { execArgv: ['--inspect=' + options.debugPort] };
            ...
            debugMode = true;
            forkExecArgv = { execArgv: ['--inspect-brk=' + options.debugPortIde] };
        }
    ...
    function processResultsAndRunTheNextIteration(msg) {
        ...
        if (!ts.iterationCount || tsit > ts.iterationCount || _testKilled) {  // if we are done with test suite iterations
