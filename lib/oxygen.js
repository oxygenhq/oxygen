...
var allowRequire = config.has('allowRequire') ? config.get('allowRequire') : false;
var requireBaseFolder = config.has('requireBaseFolder') ? config.get('requireBaseFolder') : null;
// setup logger
...
module.exports.Runner = function () {
    ...
    module.init = function (options) { /*args, mode, debugPort*/
        ...
        options.allowRequire = options.allowRequire || allowRequire;
        // requireBaseFolder restricts require to a specific folder
        options.requireBaseFolder = options.requireBaseFolder || requireBaseFolder;
        logger.info('requireBaseFolder: ' + options.requireBaseFolder);
