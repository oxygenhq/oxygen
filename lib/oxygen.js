...
// export Page Objects related classes
module.exports.po = {};
module.exports.po.Element = require('./page-objects/Element');
module.exports.po.MobileElement = require('./page-objects/MobileElement');
module.exports.po.WebElement = require('./page-objects/WebElement');
...
module.exports.Runner = function () {
    ...
    module.init = function (options) {
        ...
        if (options.debugPort) {
            forkExecArgv = { execArgv: ['--debug=' + options.debugPort] };
        } else if (options.debugPortIde) {
            ...
            debugMode = true;
            forkExecArgv = { execArgv: ['--debug-brk=' + options.debugPortIde] };
        }
        ...
        if (debugMode) {
            ...
            initializeDebugger(options.debugPortIde, childProc, options);
        } else {
