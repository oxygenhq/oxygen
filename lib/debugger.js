...
class Debugger extends EventEmitter {
    ...
    async connect(port, host) {
        ...
        this._client.on('Debugger.paused', (e) => {
            ...
            console.log('~~ Debugger.paused', JSON.stringify(e, null, 2));
            console.log('~~ this._breakpoints', JSON.stringify(this._breakpoints, null, 2));
            this._paused = true;
    ...
    async stepOver() {
        return await this._Debugger.stepOver();
    }
