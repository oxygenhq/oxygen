...
var self = module.exports = {
    ...
    generateTestSuiteFromJsonFile: function (filePath, paramFile, paramMode, options) {
        ...
        _.each(conf.cases, function(caseDef) {
            ...
            tc.format = 'js';
            tc.iterationCount = Number.isInteger(caseDef.iterationCount) ? caseDef.iterationCount : 1;
            tc.rampup = caseDef.rampup || 0;
            tc.parallel = caseDef.parallel || 1;
            tc.maxDuration = caseDef.duration || null;
