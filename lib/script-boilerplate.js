    ...
    get: function () {
        ...
        for (var call of __stack) {           
            ...
            if (callFileName && callFileName.indexOf('script-boilerplate.js') === -1) {
                ...
                } else if(call.getFunction() && call.getFunction().toString){
                    if(call.getFunction().toString().startsWith('function (exports, require, module, __filename, __dirname')){
                        // required file was not a nodejs module, and was wrapped;
                        line--;
                    }
                }
                lines.push({
