...
const ScriptError = require('../errors/ScriptError');
const errHelper = require('../errors/helper');
const StepResult = require('../model/stepresult');
const Failure = require('../model/stepfailure');
const path = require('path');
const globule = require('globule');
const oxutil = require('./util');
const getPageObjectRepository = require('./page-objects/util').getPageObjectRepository;
const fs = require('fs');
var modules = {};
var sandbox = {};
var Fiber = null;
...
process.on('message', function (msg) {
    ...
    if (msg.type === 'init') {
        ...
        runScript(scriptContent, requireBaseFolder, msg.scriptName, options.poFile || null);
...
function runScript(scriptContent, requireBaseFolder, name, poFilePath) {
    var vm = require('vm');
    ...
    try {
        ...
        sandbox.po = getPageObjectRepository(poFilePath, requireBaseFolder, poCache, ctx, modules);
