        ...
        try {
            ...
            for (var fileName of files) {
                ...
                if (commandName.indexOf('.') !== 0) {   // ignore possible hidden files (i.e. starting with '.')
                    ...
                    mod[commandName] = cmdFunc.bind(mod._this || mod);   // set "this" to the module the current command
                }
            }
        } catch (e) {
    ...
    Object.keys(module).forEach(function (methodName) {
        ...
        if (methodName.indexOf('_') === 0) {
            wrapper[methodName] = function() {
                ...
                try {
                    ...
                    throw errHelper.getOxygenError(e, methodName, args);
                }
            };
            return;
        }
        ...
        wrapper[methodName] = function() {
            ...
            try {
                ...
                error = errHelper.getOxygenError(e, methodName, args);
            }
