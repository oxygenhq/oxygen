...
global.ox = {};
// fix webdriver.io issue with missing global.browser object
global.browser = {};
...
function runScript(scriptContent, requireBaseFolder, name, path) {
    ...
    try {
        ...
        for (property in ctx.params) {
            if (Object.prototype.hasOwnProperty.call(ctx.params, property)) {
        ...
        for (property in ctx.env) {
            if (Object.prototype.hasOwnProperty.call(ctx.env, property)) {
...
function moduleWrapper(name, module, resultStore) {
    ...
    Object.keys(module).forEach(function (methodName) {
        ...
        wrapper[methodName] = function() {
            ...
            if (publicMethod) {
                processSend({ event: 'line-update', stack: __lineStack });
            }
